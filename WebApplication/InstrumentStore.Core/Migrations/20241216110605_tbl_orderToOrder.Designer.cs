...
namespace InstrumentStore.Domain.Migrations
{
    ...
    [Migration("20241216110605_tbl_orderToOrder")]
    partial class tbl_orderToOrder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InstrumentStore.Domain.DataBase.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("InstrumentStore.Domain.DataBase.Models.OrderItem", b =>
                {
                    ...
                    b.Property<Guid>("tbl_OrderOrderId")
                        .HasColumnType("uniqueidentifier");

                    b.HasIndex("ProductId");

                    b.HasIndex("tbl_OrderOrderId");
            ...
            modelBuilder.Entity("InstrumentStore.Domain.DataBase.Models.OrderItem", b =>
                {
                    ...
                    b.HasOne("InstrumentStore.Domain.DataBase.Models.Order", "tbl_Order")
                        .WithMany()
                        .HasForeignKey("tbl_OrderOrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
